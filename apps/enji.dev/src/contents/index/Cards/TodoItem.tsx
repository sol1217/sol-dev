...
import sotfware  from "../../../../public/assets/images/software-developer.jpg"
...
function TodoItem({
  state,
  date = 'Skills and Tools',
  tag1 = 'Web Application ',
  tag2 = 'Web Developer',
}: TodoItemProps) {
  return (
    <div
    ...
    >
      ...
      <Image src={sotfware} alt="sotfware image" width={400} height={50}/>
