  ...
  return (
    ...
    >
      ...
      <span className={clsx('flex-1')}>
        ...
        {href &&(
          <Link style={{color: "#a88bfa", borderBottomStyle: "solid", borderBottomWidth: 1, borderBottomColor:"#a88bfa", fontSize: 14, fontWeight: "bold" }} className="hover:text-blue-500" href={href}>GitHub repository</Link>
        )}
      </span>
    </button>
  );
