...
import segway from "../../public/assets/images/segway-logo.png";
...
export function SegwayLogo(props: ComponentProps<'svg'>) {
  return (
    <Image src={segway} alt="segway" width={13} height={13}/>
