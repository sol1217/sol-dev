  ...
  return (
    <div className={clsx('max-w-[348px]')}>
      ...
      <p className={clsx('mb-4 font-normal leading-relaxed')}>
        I&apos;m Sol Calderón, a <strong>front-end developer</strong> who loves
        intuitive, clean and modern UI design.
      </p>
      <ul className={clsx('-ml-2 flex gap-1')}>
        <li>
          <a
            href="https://x.com/SolCaldero41024"
            target="_blank"
            rel="noreferrer nofollow"
        ...
        <li>
          <a
            href="https://www.figma.com/files/team/1242548376330128484/recents-and-sharing/recently-viewed?fuid=1242131447687661962"
            target="_blank"
            rel="noreferrer nofollow"
            className={clsx('flex h-9 w-9 items-center justify-center')}
      ...
      <div className={clsx('content-wrapper')}>
              ...
              <div className={clsx('flex', 'sm:gap-16')}>
                <FooterGroup
                  ...
                  links={[
                    ...
                    { title: 'References', href: '/work/references' },
                  ]}
                />
                <FooterGroup
                  title="Learn"
              ...
              <div className={clsx('flex', 'sm:gap-16')}>
                <FooterGroup
                  ...
                  links={[
                    {
                      title: 'Linkedin',
                      href: 'https://www.linkedin.com/in/sol-calderón-30aa7425a/',
                      isInternal: false,
                    },
                    {
                      title: 'Git Hub',
        ...
        >
          <div className={clsx('font-semibold')}>
            &copy; {dayjs().format('YYYY')}, Sol Calderón
          </div>
