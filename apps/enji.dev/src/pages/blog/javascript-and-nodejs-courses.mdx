---
title: Javascript and Node js courses (Udemy) 📱
description: A 50-hour course offering in-depth training in JavaScript and Node.js, covering basic to advanced concepts.
lang: en
date: '2023-02-06'
tags:
  - tailwindcss
